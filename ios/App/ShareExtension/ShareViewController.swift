...
//  ShareExtension
//
//  Created by Naptie on 2025/2/21.
//
...
class ShareViewController: UIViewController {
    ...
    private func sendData() {
        ...
        var urlComps = URLComponents(string: "phizone-player://")!
    ...
    fileprivate func createSharedFileUrl(_ url: URL?) -> String {
        ...
        let copyFileUrl =
        fileManager.containerURL(forSecurityApplicationGroupIdentifier: "group.cn.phizone.player")!
